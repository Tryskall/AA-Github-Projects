// File ttt-ai-spec.js for mocha testing AI player in TTT-ai class
...
describe ('ComputerPlayer', function () {
  ...
  context('getWinningMoves(grid, symbol)', () => {
  ...
  context('getSmartMove(grid, symbol)', () => {
